...
```sh
git clone git@github.com:byrzhm/MyFirstChiselProject.git
cd MyFirstChiselProject
```
...
#### Commit your changes
```sh
git commit -m 'Starting MyFirstChiselProject'
...
```sh
mill MyFirstChiselProject.test
```
